...
1. Minimise register usage
2. Reduce shared memory consumption
3. Balance thread divergence
4. Align memory access patterns

### Common Optimisation Techniques

- Coalesced memory access
- Minimising thread divergence
- Maximising parallel execution
- Reducing data transfer overhead

## Key Takeaways

- CUDA is a hierarchical, parallel computing model
- Efficient execution requires understanding of hardware architecture
- Optimisation is about maximising resource utilisation
- Different memory types serve different performance needs
