...
However, a per-particle neighbour list can provide better GPU performance. This approach trades some redundant computations (each particle pair will be visited twice) for massively parallel bond force computation and some parallelism in the reduction step.
